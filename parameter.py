...
data_refind = re.compile("(sfzx:.*?askforleave: 0)", re.S)
...
daily_logger = logging.getLogger('daily_report')
...
if DEBUG:
    ...
    logging.getLogger('daily_report').addHandler(console)
...
history_url = 'https://app.bupt.edu.cn/ncov/wap/default/index'
daily_report_api = 'https://app.bupt.edu.cn/ncov/wap/default/save'
