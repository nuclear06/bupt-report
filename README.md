...
本程序会在北京时间`02:30、03:30`,`14:30、15:30`, `20:30、21:30`进行签到（考虑到github的action很不准，而且因为网络波动可能导致的打卡失败），并通过邮件返回是否打卡成功的信息（只测试了QQ邮箱，使用QQ邮箱的授权码进行发送，相关内容参考QQ官方帮助文档https://service.mail.qq.com/cgi-bin/help?subtype=1&id=28&no=1001256）
