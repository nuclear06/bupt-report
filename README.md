...
本程序会在时段(北京时间)`01:00-03:00`,`13:00-15:00`, `19:00-21:00`每隔40分钟进行一次签到（考虑到github的action很不准，而且因为网络波动可能导致的打卡失败）
...
> 本来写好了向一个函数，结果发现只要向填报的服务器发送请求就会算你填报上，哪怕你什么信息也没给他！！！于是最后取消了本功能
